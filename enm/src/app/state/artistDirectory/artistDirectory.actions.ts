...
export const artistDirectoryFilter = createAction('[Artist Directory Screen] Artists Directory Filter', props<{ text: string, recentlyListed: boolean, sortByYearDescending: boolean, recentlyToured: boolean, randomArtist: boolean, womanFronted: boolean, recentlyAdded: boolean, includesWomen: boolean, rock: boolean, punk: boolean, metal: boolean, edm: boolean, rap: boolean, jazz: boolean, pop: boolean, experimental: boolean, latin: boolean, other: boolean }>()); 
